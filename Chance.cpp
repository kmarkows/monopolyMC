...
Chance::Chance()
{
	...
	cards.at(6) = Card([](Player &player, Board &board) { player.acquireGetOutOfPrisonCard(); }, 6);
	...
	cards.at(11) = Card([](Player &player, Board &board) { player.subtractBalance(15); }, 11);

	cards.at(12) = Card([](Player &player, Board &board) { player.setCurrTile(39); }, 12);
	...
	cards.at(14) = Card([](Player &player, Board &board) { player.addBalance(150); }, 14);
}
